...
class GenericDataLoader:
    ...
    def __init__(self, data_folder: str = None, prefix: str = None, corpus_file: str = "corpus.jsonl", query_file: str = "queries.jsonl", instr_file: str = "instructions.jsonl", 
        ...
        self.instr_file = os.path.join(data_folder, instr_file) if data_folder else instr_file
    ...
    def load_custom(self) -> Tuple[Dict[str, Dict[str, str]], Dict[str, str], Dict[str, Dict[str, int]]]:
        ...
        self.check(fIn=self.instr_file, ext="jsonl")
        ...
        return self.corpus, self.queries, self.qrels, self.instructions
        ...
        with open(self.query_file, encoding='utf8') as fIn:
            for line in fIn:
                ...
                self.queries[line.get("_id")] = {
                    "text": line.get("text"),
                    "instruction_id":line.get('instruction_id')
                }
    
    
    def _load_instructions(self):
        
        with open(self.instr_file, encoding='utf8') as fIn:
            for line in fIn:
                line = json.loads(line)
                self.instructions[line.get("_id")] = line.get("text")
