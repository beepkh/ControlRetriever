...
from pygaggle.model.tokenize import QueryDocumentBatch,QueryDocumentBatchTokenizer,T5BatchTokenizer
from pygaggle.model.decode import greedy_decode
# from pygaggle.model import (QueryDocumentBatch,
...
class MonoT5(Reranker):
    ...
    def get_tokenizer(pretrained_model_name_or_path: str,
                      *args, batch_size: int = 5, **kwargs) -> T5BatchTokenizer:
